...
INSERT INTO student (student_ID, person_id, lesson_ID, personNumber, parentPhoneNumber, parentEmail)
VALUES
    (1, 1, 1, 'STU123', '5559876543', 'parent1@example.com'),
    (2, 2, 2, 'STU456', '5551234567', 'parent2@example.com'),
    (3, 3, 3, 'STU789', '5555555555', 'parent3@example.com');
...
VALUES
    ('ENS001', 2, 1, 8, 4, 'Classical', '2023-08-20 15:00'),
    ('ENS002', 3, 2, 10, 5, 'Rock', '2023-08-21 17:30');
