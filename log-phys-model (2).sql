...
ALTER TABLE parent ADD CONSTRAINT PK_parent PRIMARY KEY (id,id_0);
...
ALTER TABLE contacts ADD CONSTRAINT FK_contacts_0 FOREIGN KEY (id) REFERENCES person (id);
...
ALTER TABLE instrument ADD CONSTRAINT FK_instrument_0 FOREIGN KEY (id) REFERENCES student (id);


ALTER TABLE lease ADD CONSTRAINT FK_lease_0 FOREIGN KEY (id) REFERENCES instrument (id);
...
ALTER TABLE parent ADD CONSTRAINT FK_parent_1 FOREIGN KEY (id_0) REFERENCES lease (id);
